...
export class Migration1767218429047 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "idx_company_email" ON "companies" ("email") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "idx_vendor_company_id" ON "vendors" ("company_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "idx_vendor_name" ON "vendors" ("name") `,
    );
    await queryRunner.query(
      `CREATE INDEX "idx_vendor_tax_id" ON "vendors" ("tax_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "idx_vendor_is_active" ON "vendors" ("is_active") `,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX "idx_vendor_company_email" ON "vendors" ("company_id", "email") WHERE "email" IS NOT NULL`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "idx_client_company_id" ON "clients" ("company_id") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "idx_client_is_active" ON "clients" ("is_active") `,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX "idx_client_company_email" ON "clients" ("company_id", "email") WHERE "email" IS NOT NULL`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "idx_sale_company_id" ON "sales" ("company_id") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "idx_sale_company_invoice" ON "sales" ("company_id", "invoice_number") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "idx_purchase_company_id" ON "purchases" ("company_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "idx_purchase_vendor_id" ON "purchases" ("vendor_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "idx_purchase_po_number" ON "purchases" ("po_number") `,
    );
    await queryRunner.query(
      `CREATE INDEX "idx_purchase_order_date" ON "purchases" ("order_date") `,
    );
    await queryRunner.query(
      `CREATE INDEX "idx_purchase_status" ON "purchases" ("status") `,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX "idx_purchase_company_po" ON "purchases" ("company_id", "po_number") `,
    );
    await queryRunner.query(
      `CREATE TABLE "purchase_line_items" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "purchase_id" uuid NOT NULL, "product_id" uuid, "description" character varying(255) NOT NULL, "quantity" numeric(12,4) NOT NULL DEFAULT '1', "unit_cost" numeric(12,2) NOT NULL DEFAULT '0', "tax_rate" numeric(5,2) NOT NULL DEFAULT '0', "tax_amount" numeric(12,2) NOT NULL DEFAULT '0', "subtotal" numeric(12,2) NOT NULL DEFAULT '0', "total" numeric(12,2) NOT NULL DEFAULT '0', "quantity_received" numeric(12,4) NOT NULL DEFAULT '0', CONSTRAINT "PK_4605eaedb9e32cff205e7ae5ec3" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "idx_purchase_line_item_purchase_id" ON "purchase_line_items" ("purchase_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "idx_purchase_line_item_product_id" ON "purchase_line_items" ("product_id") `,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "users" ADD "permissions" jsonb NOT NULL DEFAULT '[]'::jsonb`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "vendors" ADD CONSTRAINT "FK_417f012e92f382001c77b953c57" FOREIGN KEY ("company_id") REFERENCES "companies"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "sale_line_items" ADD CONSTRAINT "FK_dae75d3339ca2915ec04a55b459" FOREIGN KEY ("sale_id") REFERENCES "sales"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "sale_line_items" ADD CONSTRAINT "FK_d63e2808c2186b3c762b0bb5267" FOREIGN KEY ("product_id") REFERENCES "products"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "purchases" ADD CONSTRAINT "FK_c594d713693899d85f454ccdebe" FOREIGN KEY ("company_id") REFERENCES "companies"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "purchases" ADD CONSTRAINT "FK_b9a9f16702bc091db7eb5e0d9c7" FOREIGN KEY ("vendor_id") REFERENCES "vendors"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "purchase_line_items" ADD CONSTRAINT "FK_e3765c149299492f8da7b33cb40" FOREIGN KEY ("purchase_id") REFERENCES "purchases"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "purchase_line_items" ADD CONSTRAINT "FK_7eb1def62db5a4664d2bd7784b7" FOREIGN KEY ("product_id") REFERENCES "products"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "purchase_line_items" DROP CONSTRAINT "FK_7eb1def62db5a4664d2bd7784b7"`,
    );
    await queryRunner.query(
      `ALTER TABLE "purchase_line_items" DROP CONSTRAINT "FK_e3765c149299492f8da7b33cb40"`,
    );
    await queryRunner.query(
      `ALTER TABLE "purchases" DROP CONSTRAINT "FK_b9a9f16702bc091db7eb5e0d9c7"`,
    );
    await queryRunner.query(
      `ALTER TABLE "purchases" DROP CONSTRAINT "FK_c594d713693899d85f454ccdebe"`,
    );
    await queryRunner.query(
      `ALTER TABLE "sale_line_items" DROP CONSTRAINT "FK_d63e2808c2186b3c762b0bb5267"`,
    );
    await queryRunner.query(
      `ALTER TABLE "sale_line_items" DROP CONSTRAINT "FK_dae75d3339ca2915ec04a55b459"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "vendors" DROP CONSTRAINT "FK_417f012e92f382001c77b953c57"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."idx_purchase_line_item_product_id"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."idx_purchase_line_item_purchase_id"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."idx_sale_line_item_product_id"`,
    );
