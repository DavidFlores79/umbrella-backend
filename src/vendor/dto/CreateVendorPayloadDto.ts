// ABOUTME: DTO for creating a new vendor with validation rules.
// ABOUTME: Contains required and optional fields for vendor creation.
...
export class CreateVendorPayloadDto {
  @ApiProperty({
